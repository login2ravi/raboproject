...
public class SecurityFilterTest {
    ...
    @Test
    public void doFilterInternalForOptions() throws ServletException, IOException {
    ...
    @Test
    public void doFilterInternalForValidToken() throws ServletException, IOException {
